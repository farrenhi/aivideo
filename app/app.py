...
@app.route('/api/shooting', methods=['GET']) # should be POST ! but it would not work
async def get_attractions():
    ...
    if cloudfront_link is not None:
        response = {
            "data":{
                "video_url": cloudfront_link,
            }
        }
